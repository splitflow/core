...
export function isNumberDef(definition: DataDef): definition is NumberDef {
...
export interface NumberAccessor {
    ...
    removeDigit(value: string): string
    increment(value: string): string
    decrement(value: string): string
    format(value: string): string
}

export function compileNumber({ precision, min, max, step, unit }: NumberDef): NumberAccessor {
    return {
        addDigit(value: string, digit: string): any {
...
function addDigit(value: string, digit: string) {
    if (digit === '.') {
        if (!value) return '0.'
...
function removeDigit(value: string) {
...
function increment(value: string, step: number, precision: number) {
...
function decrement(value: string, step: number, precision: number) {
    if (!step) return value
    if (!value) return value
    if (value === '0') return null
...
function bound(value: string, min: number, max: number) {
    if (!value) return value
